...
- **`core/`** — Video analysis, DB utilities, schema migrations, face recognition helpers, config subentry resolution, config-entry lifecycle helpers (deferred engine start)
