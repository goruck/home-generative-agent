...
Click the button below to add the repository, then install and configure the add-on per its [documentation](https://github.com/goruck/addon-postgres-pgvector/blob/main/postgres_pgvector/DOCS.md).
