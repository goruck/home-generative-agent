"""Coordinator for Home Generative Agent integration."""
...
@dataclass
class HomeGenerativeAgentAPIData:
...
class HomeGenerativeAgentCoordinator(DataUpdateCoordinator):
    ...
    async def async_update_data(self):
        ...
        return HomeGenerativeAgentAPIData(self.api.controller_name, devices)
