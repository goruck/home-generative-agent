        ...
        async with httpx.AsyncClient(timeout=timeout) as client:
            ...
            response = await client.post(
                ...
                json={
                    "url": url,
                    "elements": [
                        {"selector": "article", "timeout": 3500},
                        {"selector": "main", "timeout": 3500},
                        {"selector": "p", "timeout": 3500},
                        {"selector": "h1", "timeout": 3500},
                        {"selector": "h2", "timeout": 3500},
                        {"selector": "h3", "timeout": 3500},
                        {"selector": "h4", "timeout": 3500},
                        {"selector": "h5", "timeout": 3500},
                        {"selector": "h6", "timeout": 3500},
                        {"selector": "li", "timeout": 3500},
                        {"selector": "blockquote", "timeout": 3500},
                        {"selector": "pre", "timeout": 3500},
                        {"selector": "code", "timeout": 3500},
                    ],
                    "bestAttempt": True,
                },
            )
