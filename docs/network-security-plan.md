...
| `eero` | `platform == "eero"` | the network-level rows of the eero table below (shipped: `snapshot/router.py`); per-client sensors follow with the baseline step | 1 |
