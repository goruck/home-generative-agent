...
| `motion_detected_while_away` | Motion while nobody is home, any hour. Same pet/VMD noise caveat as the night variant, and daytime adds benign visitors (cleaners, deliveries) — defaults to low severity for that reason |
