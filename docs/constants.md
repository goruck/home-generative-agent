...
| `RECOMMENDED_SENTINEL_HA_TOKEN_STALE_DAYS` | `sentinel_ha_token_stale_days` | `90` | Days a long-lived access token may go unused before `ha_long_lived_token_stale` fires |
